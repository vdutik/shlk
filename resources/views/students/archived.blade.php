                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                ...
                                                <form action="{{ action('StudentController@destroy', $student->user->id) }}" method="post">
                                                    ...
                                                    <button type="button" class="dropdown-item" onclick="confirm('Are you sure you want to delete Student {{ $student->getStudentNo() }} {{ $student->user->getName() }}? Doing this will also delete the grades associated with this account. You may want to archive this Student instead.') ? this.parentElement.submit() : ''">
                                                        Delete
                                                    </button>
                                                </form>
