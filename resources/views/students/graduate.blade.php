        ...
        <div class="col-xl-12 mb-5 mb-xl-0">
            ...
            @if(count($students) > 0 || $search != null)
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col col-lg-3">
                            <h3 class="mb-0">Graduate Students</h3>
                        </div>

                        <div class="col col-lg-4">
                            <form action="/graduate/students?" method="get" class="form-horizontal">
                        ...
                        <table class="table align-items-center table-flush {{ count($students) < 5 ? 'mb-6' : ''}}">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col">Date Graduated</th>
                                    <th scope="col"></th>
                                </tr>
                            </thead>
                            <tbody>
                            @foreach ($students as $student)
                                <tr>
                                    ...
                                    <td>{{ $student->getDateGraduated() }}</td>
                                    <td class="text-right">
                                        <div class="dropdown">
              ...
              @else
                  <div class="row mt-3 mb-5">
                      <div class="col text-center">
                          <p class="lead">No graduate student found</p>
                          <br>
