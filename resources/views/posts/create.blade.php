        ...
        <div class="row mt-5">
            <div class="col-xl-12 mb-5 mb-xl-0">
                <div class="card shadow">
                    <div class="card-body">
                        <form id="form-post" method="POST" action="{{ action('PostsController@store') }}"
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-5">
                                    ...
                                    <div class="form-group">
                                        <label id="browse-image" for="cover_image" class="btn btn-outline-default">Choose
                                            Cover Image</label>
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-8">
                                    ...
                                    <input id="title" name="title" class="form-control mb-3" type="text"
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-8">
                                    ...
                                    <input id="sort" value="500" name="sort" class="form-control mb-3" type="text"
                                           placeholder="Введіть сортувальне число" required>
                                </div>
                            </div>
